...
public class UserService implements IUserService{
    ...
    public User getUserById(Long userId) {
        return userRepository
                .findById(userId)
                .orElseThrow(() -> new ResourceNotFoundException("No user with " + userId + " found"));
    }
    ...
    public User createUser(CreateUserRequest request) {
        return Optional.of(request).filter(user -> !userRepository.existsByEmail(request.getEmail()))
                ...
                }).orElseThrow(() -> new ResourceAlreadyExistsException("User with " + request.getEmail() + " already exists"));
    }
    ...
    public void deleteUser(Long userId) {
        userRepository
                ...
                .ifPresentOrElse(userRepository::delete,
                        () -> {
                    throw new ResourceNotFoundException("No user with " + userId + " found");
                });
    }
